"use strict";
/**
 * The single-source-of-truth of the Armor server configuration
 *
 * This defines _both_ what the CLI supports and what the config files support.
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.ArmorConfigJsonSchema = void 0;
exports.ArmorConfigJsonSchema = ({
    ...
    properties: {
        $schema: {
            ...
            default: 'https://raw.githubusercontent.com/armor/armor/master/packages/schema/lib/armor-config.schema.json',
            type: 'string',
            format: 'uri',
        },
        server: {
            ...
            properties: {
                ...
                'allow-cors': {
                    description: 'Whether the Armor server should allow web browser connections from any host',
                ...
                'keep-alive-timeout': {
                    armorCliAliases: ['ka'],
                    default: 600,
                    description: 'Number of seconds the Armor server should apply as both the keep-alive timeout and the connection timeout for all requests. A value of 0 disables the timeout.',
                    minimum: 0,
                ...
                nodeconfig: {
                    ...
                    description: 'Path to configuration JSON file to register Armor as a node with Selenium Grid 3; otherwise the configuration itself',
                ...
                'strict-caps': {
                    default: false,
                    description: 'Cause sessions to fail if desired caps are sent in that Armor does not recognize as valid for the selected device',
                    title: 'strict-caps config',
                    type: 'boolean',
                },
                tmp: {
                    armorCliDest: 'tmpDir',
                    description: 'Absolute path to directory Armor can use to manage temp files. Defaults to C:\\Windows\\Temp on Windows and /tmp otherwise.',
                    title: 'tmp config',
                    type: 'string',
                },
                'trace-dir': {
                    description: 'Absolute path to directory Armor can use to save iOS instrument traces; defaults to <tmp>/armor-instruments',
                    title: 'trace-dir config',
                    type: 'string',
                },
                'use-drivers': {
                    armorCliDescription: 'A list of drivers to activate. Can be a comma-delimited string or path to CSV file. By default, all installed drivers will be activated. Windows environments may require wrapping the comma-delimited string with quotes to escape the comma.',
                    default: [],
                ...
                'use-plugins': {
                    armorCliDescription: 'A list of plugins to activate. Can be a comma-delimited string, path to CSV file, or the string "all" to use all installed plugins. Windows environments may require wrapping the comma-delimited string with quotes to escape the comma.',
                    default: [],
...
//# sourceMappingURL=armor-config-schema.js.map