...
export type W3C_ARMOR_PREFIX = 'armor';
/**
...
/**
 * Like {@linkcode BaseCapabilities}, except all Armor-specific keys are namespaced.
 */
 ...
 */
export type CapsToNSCaps<T extends StringRecord, NS extends string = W3C_ARMOR_PREFIX> = {
 ...
 */
export type NamespacedString<S extends string, NS extends string = W3C_ARMOR_PREFIX> = `${NS}:${S}`;
/**
 ...
 */
export type NSCapabilities<C extends Constraints, NS extends string = W3C_ARMOR_PREFIX> = Partial<CapsToNSCaps<ConstraintsToCaps<C>, NS>>;
/**
