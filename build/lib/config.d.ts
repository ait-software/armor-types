...
export type NormalizedServerConfig = {
    [Prop in keyof ServerConfigMapping as ArmorServerJsonSchema[Prop] extends WithDest ? ArmorServerJsonSchema[Prop]['armorCliDest'] : KebabToCamel<Prop>]: ServerConfig[Prop];
};
/**
